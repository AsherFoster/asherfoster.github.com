    ...
    <div>
        ...
        <div id='section-1' className='section'>
            ...
            <div className='section-text'>
                ...
                <div className='section-links'>
                    ...
                    <a href='//developster-archive.medium.com'>Developster Blog&nbsp;></a>
                </div>
            </div>
            <div className='section-image'>
                <img src='../static/admin2.png' />
            </div>
        </div>
        <div id='section-2' className='section section-rev'>
            ...
            <div className='section-text'>
                ...
                <p>If one examines constructivism, one is faced with a choice: either reject
                    ...
                    in a more self-sufficient sense. </p>
                <div className='section-links'>
                    <a href='/gh'>API Server ></a>
                    <a href='/gh'>Server Status ></a>
                </div>
            </div>
        </div>
        <div id='section-3' className='section'>
            ...
            <div className='section-item'>
                ...
                <h3>Cloud</h3>
                <a href='/cloud'>Azure work&nbsp;></a>
            </div>
            <div className='section-item'>
                <img src='../static/layers.svg'/>
                <h3>Full stack</h3>
                <a href='/fs'>Server Status app&nbsp;></a>
            </div>
            <div className='section-item'>
                <img src='../static/edit.svg'/>
                <h3>Design</h3>
                <a href='/design'>Portfolio Development&nbsp;></a>
            </div>
        </div>
        <Footer/>
